...
Write a function that can be used to calculate the mean and standard
 deviation of an array of double precision floating point numbers. Note
 that the standard deviation σ of a collection of numbers xj , j = 1, 2, . . . , N is given by bla bla bla.
*/
